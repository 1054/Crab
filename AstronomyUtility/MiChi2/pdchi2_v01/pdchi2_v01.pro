...
; 
; 
PRO PdChi2_v01, InputDAT, InputLIB, InputFIT
    ...
    FOR i=0, N_ELEMENTS(PdChi2_NPars)-1 DO BEGIN
        ;PdChi2_Col_iLib = DOUBLE(CrabTableReadColumn(PdChi2_FIT,2+2*i+1))
        ...
        FOR j=0, PdChi2_NPars[i]-1 DO BEGIN
            ...
            DEVICE, FILENAME="Output_PDCHI2_LIB_"+STRING(FORMAT='(I0)',i+1)+"_PAR_"+STRING(FORMAT='(I0)',j+1)+".histogram.eps", $
            ...
            OPENW, OutputLUN, "Output_PDCHI2_LIB_"+STRING(FORMAT='(I0)',i+1)+"_PAR_"+STRING(FORMAT='(I0)',j+1)+".histogram.txt", /GET_LUN
            ...
            OPENW, OutputLUN, "Output_PDCHI2_LIB_"+STRING(FORMAT='(I0)',i+1)+"_PAR_"+STRING(FORMAT='(I0)',j+1)+".bestfit.txt", /GET_LUN
            PRINTF, OutputLUN, "# Current Time "+CrabStringCurrentTime()
            PRINTF, OutputLUN, "# "
