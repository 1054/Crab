...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_myHighLighter_t, stringdata) + ofs \
...
const QMetaObject myHighLighter::staticMetaObject = {
    { &QSyntaxHighlighter::staticMetaObject, qt_meta_stringdata_myHighLighter.data,
      qt_meta_data_myHighLighter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myHighLighter.stringdata))
