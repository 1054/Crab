...
long CrabStringFindWholeWord(const string &t, const string &strsearch, const string &BreakupMark = " ", const string &BreakupMarkOnceMore = "");

long CrabStringFindWholeWord(const wstring &t, const wstring &strsearch, const wstring &BreakupMark = L" ", const wstring &BreakupMarkOnceMore = L"");

string CrabStringFindWholeWord(const string &t, size_t pos, const string &BreakupMark = " ", const string &BreakupMarkOnceMore = "");

wstring CrabStringFindWholeWord(const wstring &t, size_t pos, const wstring &BreakupMark = L" ", const wstring &BreakupMarkOnceMore = L"");
...
long CrabStringFindWholeWord(const wstring &t, const wstring &strsearch, const wstring &BreakupMark, const wstring &BreakupMarkOnceMore)
{
    size_t foundpos = 0;
    int debug = 0;
