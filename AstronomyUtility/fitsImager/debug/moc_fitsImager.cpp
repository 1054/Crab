...
**
** Created: Sun Apr 15 17:23:34 2012
...
static const char qt_meta_stringdata_fitsImager[] = {
    "fitsImager\0\0openFile()\0saveFile()\0"
};

const QMetaObject fitsImager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_fitsImager,
      qt_meta_data_fitsImager, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &fitsImager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_fitsImager))
