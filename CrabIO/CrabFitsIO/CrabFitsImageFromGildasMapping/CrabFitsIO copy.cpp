...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*add a keyword value.*/
int addKeyword(const char *strKeyName, const char *strKeyValue, const char *strHeader, const char *strComment)
{
    int errorcode=0;
    int i=0,k=0;
    int isHeader=0;          //whether this line is simple text (header).
    ...
    if(errorcode==-1) {
        ...
        while(isHeader==1) {
            ...
            //<TODO>
            //<TODO>
            //<TODO> WRITE A CODE TO ADD KEYWORD !!! <20150215>
            //<TODO>
            //<TODO>
            //<TODO>
            //<TODO>
...
const char *generateFitsHeaderFS(int DataWidth, int DataHeight)
{
   ...
   temp1=strlen(chrnnX);
   temp2=strlen(chrnnY);
   printf("NAXIS1-strlen=%d\n",temp1);
   printf("NAXIS2-strlen=%d\n",temp2);
   for(i=0;i<temp1;i++)
   {
