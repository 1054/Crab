...
public:
    ...
    BooleanCheckBoxDelegate(QObject *parent = nullptr): QStyledItemDelegate(parent){}
    ...
    QWidget *createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const
    {
        ...
        qDebug() << "BooleanCheckBoxDelegate::createEditor()" << "index.data()" << index.data();
    ...
    {
        qDebug() << "BooleanCheckBoxDelegate::setEditorData()" << "index.data()" << index.data();
